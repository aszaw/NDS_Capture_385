...
-- Date        : Mon Nov 25 19:09:16 2024
-- Host        : DESKTOP-0G38QBS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Aaro/Desktop/385/NDS_Capture_385/7_2_guyanw2/ip_repo/hdmi_text_controller_1_0/src/hdmi_tx_0_1/hdmi_tx_0_sim_netlist.vhdl
-- Design      : hdmi_tx_0
...
entity hdmi_tx_0_srldelay is
  port (
    ...
    data_i : in STD_LOGIC_VECTOR ( 20 downto 0 );
    pix_clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
...
srldly_0: entity work.hdmi_tx_0_srldelay
     port map (
      data_i(20 downto 15) => blue(5 downto 0),
      data_i(14 downto 9) => green(5 downto 0),
      data_i(8 downto 3) => red(5 downto 0),
      data_i(2) => hsync,
      data_i(1) => vsync,
      data_i(0) => vde,
...
inst: entity work.hdmi_tx_0_hdmi_tx_v1_0
     port map (
      ...
      blue(5 downto 0) => blue(5 downto 0),
      green(5 downto 0) => green(5 downto 0),
      hsync => hsync,
      pix_clk => pix_clk,
      pix_clk_locked => pix_clk_locked,
      pix_clkx5 => pix_clkx5,
      red(5 downto 0) => red(5 downto 0),
      rst => rst,
      vde => vde,
      vsync => vsync
    );
