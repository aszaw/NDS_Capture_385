...
#
# Generated by Vivado on Fri Dec 13 12:39:50 -0600 2024
...
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_usb.protoinst" -log simulate.log
}
