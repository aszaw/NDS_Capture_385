...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.mb_usb \
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lab_6_2.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab_6_2.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../lab_6_2.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"../../../../lab_6_2.gen/sources_1/bd/mb_usb/ipshared/7698" \
       -input simulate.do
}
