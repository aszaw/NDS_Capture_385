...
HD_PWD='c:/users/aaro/desktop/385/nds_capture_385/nds_capture/nds_capture.tmp/hdmi_text_controller_v2_0_project/hdmi_text_controller_v2_0_project.runs/blk_mem_gen_0_synth_1'
cd "$HD_PWD"
