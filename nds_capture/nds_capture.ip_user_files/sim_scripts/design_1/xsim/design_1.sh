...
{
  file="xsim.ini"
  lib_map_path="C:/Xilinx2022/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib blk_mem_gen_v8_4_5)
