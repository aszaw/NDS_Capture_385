...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../nds_capture.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"$ref_dir/../../../../nds_capture.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../nds_capture.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../nds_capture.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../nds_capture.gen/sources_1/bd/design_1/ip/design_1_hdmi_text_controller_0_0_1/src/clk_wiz_0" \
       -input simulate.do
}
