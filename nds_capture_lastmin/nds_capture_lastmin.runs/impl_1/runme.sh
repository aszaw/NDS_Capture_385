...
HD_PWD='C:/Users/Aaro/Desktop/385/NDS_Capture_385/nds_capture_lastmin/nds_capture_lastmin.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nds_capture_lastmin_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nds_capture_lastmin_top.tcl -notrace
