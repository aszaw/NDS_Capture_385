...
HD_PWD='C:/Users/Aaro/Desktop/385/NDS_Capture_385/nds_capture_lastmin/nds_capture_lastmin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nds_capture_lastmin_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nds_capture_lastmin_top.tcl
