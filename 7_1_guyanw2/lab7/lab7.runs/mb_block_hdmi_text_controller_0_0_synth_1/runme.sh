...
HD_PWD='D:/workspace_vivado/lab7/lab7.runs/mb_block_hdmi_text_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_hdmi_text_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_hdmi_text_controller_0_0.tcl
